...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Ajustes", path: "/farmaceuticas/ajustes" },
      { name: "Solicitudes de Evidencia", path: "/farmacias/solicitudes-evidencia" },
    ],
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Canjes Reversados", path: "/transacciones/canjes-reversados" },
    ],
    requiredModules: ["users"], // Requiere módulo de usuarios
  },
  {
